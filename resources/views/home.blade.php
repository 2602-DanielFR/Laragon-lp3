...
@section('content')
<!-- Hero Section -->
<div class="relative bg-gradient-to-br from-principal via-secundario to-principal overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto text-center text-white">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('register') }}"
                    class="bg-white text-principal px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-100 transition shadow-lg">
                    Crear Proyecto
                </a>
                <a href="#proyectos"
                    class="bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-white hover:text-principal transition">
                    Explorar Causas
                </a>
            </div>
        </div>
...
<div class="bg-white py-16">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div class="p-6">
                <div class="text-4xl md:text-5xl font-bold text-principal mb-2">1,245</div>
                <div class="text-gray-600 text-lg">Proyectos Activos</div>
            </div>
            <div class="p-6">
                <div class="text-4xl md:text-5xl font-bold text-secundario mb-2">$2.5M</div>
                <div class="text-gray-600 text-lg">Recaudados</div>
            </div>
            <div class="p-6">
                <div class="text-4xl md:text-5xl font-bold text-principal mb-2">15,680</div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
            ...
            <div class="text-center">
                <div class="bg-principal-100 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
                    <svg class="w-10 h-10 text-principal" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Step 2 -->
            <div class="text-center">
                <div class="bg-secundario-100 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
                    <svg class="w-10 h-10 text-secundario" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition">
                <div class="h-48 bg-gradient-to-br from-principal-300 to-principal"></div>
                <div class="p-6">
                    <div class="text-sm text-principal font-semibold mb-2">MEDIO AMBIENTE</div>
                    <h3 class="text-xl font-bold mb-2 text-gray-800">Reforestación Amazónica</h3>
                    <p class="text-gray-600 mb-4 text-sm">Plantando 10,000 árboles para recuperar el pulmón del planeta
                    </p>
                    <div class="mb-4">
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div class="bg-principal h-2 rounded-full" style="width: 62%"></div>
                        </div>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-gray-500">235 donantes</span>
                        <a href="#" class="text-principal font-semibold hover:text-principal-dark">Ver más →</a>
                    </div>
                </div>
            </div>
            ...
            <!-- Project Card 2 -->
            <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition">
                <div class="h-48 bg-gradient-to-br from-secundario-300 to-secundario"></div>
                <div class="p-6">
                    <div class="text-sm text-secundario font-semibold mb-2">EDUCACIÓN</div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div class="bg-secundario h-2 rounded-full" style="width: 89%"></div>
                        </div>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-gray-500">187 donantes</span>
                        <a href="#" class="text-secundario font-semibold hover:text-secundario-dark">Ver más →</a>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition">
                <div class="h-48 bg-gradient-to-br from-principal-300 to-principal"></div>
                <div class="p-6">
                    <div class="text-sm text-principal font-semibold mb-2">SALUD</div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div class="bg-principal h-2 rounded-full" style="width: 76%"></div>
                        </div>
                    </div>
                    <div class="flex items-center justify-between">
        ...
        <div class="text-center mt-12">
            <a href="#"
                class="inline-block bg-gray-800 text-white px-8 py-3 rounded-full font-semibold hover:bg-gray-700 transition">
...
<!-- CTA Section -->
<div class="bg-gradient-to-r from-principal to-secundario py-20">
