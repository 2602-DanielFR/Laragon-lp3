                ...
                <div class="row g-0">
                    <div class="col-md-6 d-none d-md-flex align-items-center justify-content-center auth-left p-4">
                        <div class="text-center">
                            ...
                            <p class="small mb-0">{{ __('Establece una nueva contraseña') }}</p>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('password.update') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="email" type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus placeholder="{{ __('name@example.com') }}">
                                ...
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-login btn-lg">{{ __('Reset Password') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
